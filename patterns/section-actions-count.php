<?php
  ...
  * Slug: bpbw/section-action-count
...
<section class="wp-block-group section actions-count">
    ...
    <!-- wp:heading -->
    <h2><?php esc_html_e( 'Everyone\'s Actions Count', 'bpbw' ); ?></h2>
    <!-- /wp:heading -->

    <!-- wp:paragraph -->
    <p><?php esc_html_e( 'We are working together with many partners globally to protect the Amazon from the range of threats that it faces. Click here to find out what our partners are doing and support their efforts', 'bpbw' ); ?>.</p>
    <!-- /wp:paragraph -->
    ...
    <figure class="wp-block-gallery has-nested-images columns-3 is-cropped campaign-grid">
        ...
        <figure class="wp-block-image size-full campaign">
            ...
            <figcaption><strong><?php esc_html_e( 'Choose Earth', 'bpbw' ); ?></strong><br><?php esc_html_e( 'Support Indigenous Peoples in Brazil to Reforest the Minds.', 'bpbw' ); ?></figcaption>
        </figure>
        <!-- /wp:image -->
        ...
        <figure class="wp-block-image size-full campaign">
            ...
            <figcaption><strong><?php esc_html_e( 'Guardians of the Forest', 'bpbw' ); ?></strong><br><?php esc_html_e( 'From Nature-Based solutions to Nature and Community-Based Solutions.', 'bpbw' ); ?></figcaption>
        </figure>
        <!-- /wp:image -->
        ...
        <figure class="wp-block-image size-full campaign">
            ...
            <figcaption><strong><?php esc_html_e( 'Struggle for Life', 'bpbw' ); ?> </strong><br><?php esc_html_e( 'Guarantee Indigenous Land Rights in Brazil.', 'bpbw' ); ?></figcaption>
        </figure>
        <!-- /wp:image -->
    </figure>
    <!-- /wp:gallery -->
